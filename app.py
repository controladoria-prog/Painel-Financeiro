...
st.markdown(
    ...
    <style>
        ...
        .login-hero-title {{
            font-size: 38px; font-weight: 800; color: {COLORS["text"]};
            margin: 0 0 8px 0; line-height: 1.12; letter-spacing: -0.5px;
        }}
        .login-hero-title .dot {{ color: {COLORS["primary"]}; }}
        .login-hero-sub {{
            font-size: 13.5px; color: {COLORS["text_muted"]}; margin-bottom: 34px; max-width: 380px;
        }}
        .login-field-label {{
